...
* 🔼 Updated version to be a Data object instead of a Struct - Brooke Kuhlmann
* ⛔️ Removed RSpec shared context - Brooke Kuhlmann
* ⛔️ Removed RuboCop Performance/Sum check - Brooke Kuhlmann
...
* 🔁 Refactored version casting to no longer use struct with positions - Brooke Kuhlmann
